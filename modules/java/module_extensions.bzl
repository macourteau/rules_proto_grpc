...
def _download_plugins(module_ctx):
    ...
    for version, platform, hash in [
        ...
        ("1.82.1", "darwin-arm64", "<insert new hash here>"),
        ("1.82.1", "darwin-x86_64", "<insert new hash here>"),
        ("1.82.1", "linux-arm64", "<insert new hash here>"),
        ("1.82.1", "linux-x86_64", "<insert new hash here>"),
        ("1.82.1", "windows-x86_64", "<insert new hash here>"),
    ]:
        http_file(
